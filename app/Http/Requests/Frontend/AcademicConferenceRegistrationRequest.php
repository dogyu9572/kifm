...
class AcademicConferenceRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'refund_bank' => ['nullable', 'required_if:payment_method,bank_transfer', 'string', 'max:100'],
            'refund_account' => ['nullable', 'required_if:payment_method,bank_transfer', 'string', 'max:100'],
            'refund_holder' => ['nullable', 'required_if:payment_method,bank_transfer', 'string', 'max:100'],
    ...
    public function messages(): array
    {
        return [
            ...
            'payment_plan_ids.required' => '결제항목을 선택해 주세요.',
            'payment_plan_ids.min' => '결제항목을 선택해 주세요.',
