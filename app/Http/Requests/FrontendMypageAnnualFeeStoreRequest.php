...
class FrontendMypageAnnualFeeStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'refund_bank_name' => ['required_if:payment_method,bank_transfer', 'nullable', 'string', 'max:100'],
            'refund_account_no' => ['required_if:payment_method,bank_transfer', 'nullable', 'string', 'max:120'],
            'refund_holder_name' => ['required_if:payment_method,bank_transfer', 'nullable', 'string', 'max:120'],
    ...
    public function messages(): array
    {
        return [
            ...
            'refund_bank_name.required_if' => '환불 은행을 선택해 주세요.',
            'refund_account_no.required_if' => '환불 계좌번호를 입력해 주세요.',
            'refund_holder_name.required_if' => '예금주명을 입력해 주세요.',
