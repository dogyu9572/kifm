document.addEventListener('DOMContentLoaded', () => {
    const root = document.getElementById('bo-edu-courses-index');
    const selectAll = document.getElementById('select-all');
    const rowChecks = document.querySelectorAll('.bo-edu-course-checkbox');
    const bulkBtn = document.getElementById('bulk-delete-btn');
    const deleteForms = document.querySelectorAll('#bo-edu-courses-index .js-delete-confirm-form');
    const perPageSelect = document.querySelector('.bo-edu-course-per-page');
    const perPageForm = document.getElementById('edu-course-per-page-form');
    ...
    bulkBtn?.addEventListener('click', async () => {
        ...
        selectedIds.forEach((id) => formData.append('course_ids[]', id));
