document.addEventListener('DOMContentLoaded', () => {
    const root = document.getElementById('bo-academic-event-registrations-index');
    const selectAll = document.getElementById('select-all');
    const rowChecks = document.querySelectorAll('.bo-ae-reg-checkbox');
    const bulkBtn = document.getElementById('bulk-delete-btn');
    const perPageSelect = document.querySelector('.bo-ae-reg-per-page');
    const perPageForm = document.getElementById('bo-ae-reg-per-page-form');
    const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content');
    const deleteForms = document.querySelectorAll('.js-ae-reg-delete-form');
