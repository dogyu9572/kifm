    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form action="{{ route('backoffice.academic-event-abstracts.update', $abstract) }}" method="POST" enctype="multipart/form-data" id="bo-academic-event-abstract-form" data-events-fields='@json($eventsFieldsMap)'>
                    @csrf
                    @method('PUT')
                    @include('backoffice.academic-event-abstracts._form')
...
@section('scripts')
    ...
    <script src="{{ asset('js/backoffice/academic-event-abstracts-form.js') }}"></script>
@endsection
