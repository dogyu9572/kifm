    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form action="{{ route('backoffice.academic-event-abstracts.store') }}" method="POST" enctype="multipart/form-data" id="bo-academic-event-abstract-form" data-events-fields='@json($eventsFieldsMap)'>
                    @csrf
