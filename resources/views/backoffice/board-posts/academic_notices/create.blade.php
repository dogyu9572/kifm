...
@section('title', ($board->name ?? '학술대회 공지사항 등록'))

@section('content')
<div class="board-container">
    <div class="board-header">
        <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'academic_notices') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'academic_notices') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-group">
                    <label for="event_id" class="board-form-label">학술대회 <span class="required">*</span></label>
                    <select class="board-form-control" id="event_id" name="event_id" required>
                        <option value="">학술대회를 선택하세요</option>
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'academic_notices') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
