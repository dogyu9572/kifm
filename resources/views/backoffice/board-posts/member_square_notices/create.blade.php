...
@section('title', ($board->name ?? '학회 공지 작성'))

@section('content')
<div class="board-container">
    <div class="board-header">
        <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'member_square_notices') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'member_square_notices') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'member_square_notices') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
