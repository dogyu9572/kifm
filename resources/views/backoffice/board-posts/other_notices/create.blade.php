...
@section('title', ($board->name ?? '기타 공지 작성'))

@section('content')
<div class="board-container">
    <div class="board-header">
        <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'other_notices') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'other_notices') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> 저장
                                    ...
                                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'other_notices') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
