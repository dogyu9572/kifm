                ...
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'notice') }}" class="filter-form">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                <label for="member_type" class="filter-label">회원설정</label>
                                <select id="member_type" name="member_type" class="filter-select">
                                    <option value="">전체</option>
                                    <option value="준회원" @selected(request('member_type') === '준회원')>준회원</option>
                                    <option value="정회원" @selected(request('member_type') === '정회원')>정회원</option>
                                    <option value="평생회원" @selected(request('member_type') === '평생회원')>평생회원</option>
                                    <option value="시니어회원" @selected(request('member_type') === '시니어회원')>시니어회원</option>
                                </select>
                            </div>
                            <div class="filter-group">
