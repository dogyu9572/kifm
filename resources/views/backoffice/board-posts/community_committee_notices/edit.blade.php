...
@section('content')
@php
    $returnUrl = request('return_url', route('backoffice.board-posts.index', $board->slug ?? 'community_committee_notices'));
@endphp
<div class="board-container">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.update', [$board->slug ?? 'community_committee_notices', $post->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
