...
@section('title', $board->name ?? '위원회 공지')
    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                ...
                <a href="{{ route('backoffice.board-posts.create', $board->slug ?? 'community_committee_notices') }}" class="btn btn-success">
        ...
        <div class="board-card">
            <div class="board-card-body">
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_notices') }}" class="filter-form">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                <div class="filter-buttons">
                                    ...
                                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_notices') }}" class="btn btn-secondary">
                ...
                <div class="board-list-header">
                    ...
                    <div class="list-controls">
                        <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_notices') }}" class="per-page-form">
                ...
                <div class="table-responsive">
                    <table class="board-table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            <a href="{{ route('backoffice.board-posts.edit', [$board->slug ?? 'community_committee_notices', $post->id, 'return_url' => request()->fullUrl()]) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> 수정
                                            </a>
                                            <form action="{{ route('backoffice.board-posts.destroy', [$board->slug ?? 'community_committee_notices', $post->id]) }}" method="POST" class="d-inline js-delete-confirm-form">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">등록된 공지가 없습니다.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
