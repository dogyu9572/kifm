        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.update', [$board->slug ?? 'notice', $post->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="board-form-group">
                    ...
                    <input type="text" class="board-form-control" id="title_en" name="title_en" value="{{ old('title_en', $post->title_en ?? '') }}" maxlength="255">
                </div>
                ...
                <div class="board-form-group">
                    ...
                    <textarea class="board-form-control board-form-textarea" id="content_en" name="content_en" rows="15" data-backoffice-ckeditor data-source-editing="true">{{ old('content_en', $post->content_en ?? '') }}</textarea>
                </div>
                ...
                <div class="board-form-group">
                    ...
                    <div class="board-options-list board-options-horizontal">
                        <div class="board-option-item">
                            <input type="radio" id="is_active_public" name="is_active" value="1" @checked((string) old('is_active', (int) (bool) ($post->is_active ?? true)) === '1') required>
                            <label for="is_active_public">사용</label>
                        </div>
                        <div class="board-option-item">
                            <input type="radio" id="is_active_private" name="is_active" value="0" @checked((string) old('is_active', (int) (bool) ($post->is_active ?? true)) === '0') required>
