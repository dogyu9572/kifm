...
@section('title', $board->name ?? '학회 앨범')
    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                ...
                <a href="{{ route('backoffice.board-posts.create', $board->slug ?? 'member_square_album') }}" class="btn btn-success">
        ...
        <div class="board-card">
            <div class="board-card-body">
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'member_square_album') }}" class="filter-form">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                <div class="filter-buttons">
                                    ...
                                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'member_square_album') }}" class="btn btn-secondary">
                ...
                <div class="board-list-header">
                    ...
                    <div class="list-controls">
                        <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'member_square_album') }}" class="per-page-form">
                ...
                <div class="table-responsive">
                    <table class="board-table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            <a href="{{ route('backoffice.board-posts.edit', [$board->slug ?? 'member_square_album', $post->id, 'return_url' => request()->fullUrl()]) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> 수정
                                            </a>
                                            <form action="{{ route('backoffice.board-posts.destroy', [$board->slug ?? 'member_square_album', $post->id]) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 이 게시글을 삭제하시겠습니까?');">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">등록된 앨범이 없습니다.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
