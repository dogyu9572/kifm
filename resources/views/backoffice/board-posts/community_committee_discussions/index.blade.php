    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                ...
                <a href="{{ route('backoffice.board-posts.create', $board->slug ?? 'community_committee_discussions') }}" class="btn btn-success">
                    <i class="fas fa-plus"></i> 주제 등록
                </a>
            </div>
        </div>
        ...
        <div class="board-card">
            <div class="board-card-body">
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_discussions') }}" class="filter-form">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                <div class="filter-buttons">
                                    ...
                                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_discussions') }}" class="btn btn-secondary">
                ...
                <div class="board-list-header">
                    ...
                    <div class="list-controls">
                        <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_discussions') }}" class="per-page-form">
                ...
                <div class="table-responsive">
                    <table class="board-table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            <a href="{{ route('backoffice.board-posts.edit', [$board->slug ?? 'community_committee_discussions', $post->id, 'return_url' => request()->fullUrl()]) }}" class="btn btn-primary btn-sm">
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ ($board->enable_comments ?? false) ? 10 : 9 }}" class="text-center">등록된 토론 주제가 없습니다.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
