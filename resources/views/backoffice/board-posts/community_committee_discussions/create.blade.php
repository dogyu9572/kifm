...
@section('title', ($board->name ?? '위원회 토론장').' 작성')
...
<div class="board-container">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'community_committee_discussions') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'community_committee_discussions') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
