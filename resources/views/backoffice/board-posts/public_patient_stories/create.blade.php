...
@section('title', ($board->name ?? '환자 이야기 작성'))

@section('content')
<div class="board-container">
    <div class="board-header">
        <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'public_patient_stories') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'public_patient_stories') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'public_patient_stories') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
