...
@section('title', $board->name ?? '환자 이야기')

@section('content')
@php
    $returnUrl = request('return_url', route('backoffice.board-posts.index', $board->slug ?? 'public_patient_stories'));
@endphp
<div class="board-container">
    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.update', [$board->slug ?? 'public_patient_stories', $post->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
