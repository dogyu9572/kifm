    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form action="{{ route('backoffice.academic-sponsor-masters.store') }}" method="POST" enctype="multipart/form-data" id="bo-sponsor-master-form">
                    @csrf
                    @include('backoffice.academic-sponsor-masters._form', ['master' => $master, 'requireLogo' => true])
