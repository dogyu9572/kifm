    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form method="POST" action="{{ route('backoffice.community-committees.update', $committee) }}" enctype="multipart/form-data" id="bo-community-committee-form">
                    @csrf
                    @method('PUT')
