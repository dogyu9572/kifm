    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form method="POST" action="{{ route('backoffice.academic-events.sessions.store', $event) }}" id="bo-academic-session-form">
                    @csrf
                    ...
                    <div class="board-form-group">
                        ...
                        <input type="time" name="start_time" class="board-form-control board-form-control--max-sm" value="{{ old('start_time', $session->start_time ? substr((string) $session->start_time, 0, 5) : '09:00') }}" required>
                    </div>
                    <div class="board-form-group">
                        <label class="board-form-label">종료 시간 <span class="required">*</span></label>
                        <input type="time" name="end_time" class="board-form-control board-form-control--max-sm" value="{{ old('end_time', $session->end_time ? substr((string) $session->end_time, 0, 5) : '10:00') }}" required>
                    </div>
                    <div class="board-form-group">
