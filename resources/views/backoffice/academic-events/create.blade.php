    ...
    <div class="board-container">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <form id="bo-academic-event-form" method="POST" action="{{ route('backoffice.academic-events.store') }}" enctype="multipart/form-data"
                    ...
                    data-academic-event-id="">
                    @csrf
                    @include('backoffice.academic-events._form', ['isEdit' => false])
