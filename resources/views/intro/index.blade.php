...
<section class="intro_wrap" aria-labelledby="intro-title">
	<div class="link_btns">
		<a href="#this" class="i1">English</a>
		<a href="#this" class="i2">Journal</a>
	</div>
	<div class="intro_contents">
		<img src="/images/logo.png" alt="대한기능의학회">
		<h2 class="title">질병의 증상을 넘어, <strong class="c_iden">삶의 근본적인 건강</strong>을 디자인합니다.</h2>
		<p class="tit">환자 중심의 맞춤형 의학, 대한기능의학회가 앞선 전문성으로 내일의 건강을 제시합니다.</p>
		<div class="links">
			<a href="/home" class="i1"><span class="bg_box"><span class="txt"><h3>일반인 홈페이지</h3><p>뿌리부터 치료하는 기능의학 알아보기</p></span><i aria-hidden="true"></i><span aria-hidden="true" class="blur_bg"></span></span></a>
