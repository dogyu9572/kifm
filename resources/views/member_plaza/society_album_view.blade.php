	...
	<div class="inner">
		...
		<div class="board_view">
			<div class="tit_area">
				...
				<x-frontend.bookmark-button content-type="member_square_album" :content-id="$post->id" :title="$post->title" :menu-label="$sName" :url="route('member_plaza.society_album_show', $post->id)" />
			</div>
