...
<section class="scon" aria-labelledby="media_events-heading">
	<div class="inner">
		<div class="sub_title">{{ $sName }}</div>
		
		<div class="board_view">
			<div class="tit_area">
				<h1 class="tit" id="media_events-heading">제목이 위치할 공간입니다. 제목이 위치할 공간입니다.제목이 위치할 공간입니다.</h1>
		...
		<div class="board_bottom">
			<a href="/general_page/news/media_events" class="btn btn_wkk btn_list">목록</a>
		</div>
