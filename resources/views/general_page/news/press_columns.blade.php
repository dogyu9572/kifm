			...
			<table>
				...
				<tbody>
					<tr class="notice">
						...
						<td class="tal"><a href="/general_page/news/press_columns_view">제목이 위치할 공간입니다. 제목이 위치할 공간입니다.제목이 위치할 공간입니다. 제목이 위치할 공간입니다.제목이 위치할 공간입니다. 제목이 위치할 공간입니다.</a></td>
						<td class="date">2025.01.01</td>
					</tr>
					<tr class="notice">
						<td class="num" aria-label="공지사항"></td>
						<td class="tal"><a href="/general_page/news/press_columns_view">제목이 위치할 공간입니다. 제목이 위치할 공간입니다.제목이 위치할 공간입니다.</a></td>
						<td class="date">2025.01.01</td>
					</tr>
					<tr>
						<td class="num">8</td>
