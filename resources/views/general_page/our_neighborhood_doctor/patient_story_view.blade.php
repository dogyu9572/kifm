...
<section class="scon" aria-labelledby="press_columns-heading">
	<div class="inner">
		...
		<div class="board_view">
			<div class="tit_area">
				<h1 class="tit" id="press_columns-heading">제목이 위치할 공간입니다. 제목이 위치할 공간입니다.제목이 위치할 공간입니다.</h1>
		...
		<div class="board_bottom">
			<a href="/general_page/news/patient_story" class="btn btn_wkk btn_list">목록</a>
		</div>
