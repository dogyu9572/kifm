	...
	<tbody>
		...
		<tr>
			<td style="padding:0 40px 48px;">
				<div style="font-size:24px; color:#222; font-weight:700; line-height:1.4; letter-spacing:-.02em;">비밀번호 변경 완료 안내</div>
				<p style="font-size:16px; color:#222; line-height:1.5; letter-spacing:-.02em; margin:16px 0 40px;">
					안녕하세요, 대한기능의학회입니다.<br>
					회원님의 비밀번호가 성공적으로 변경되었습니다.<br>
					<br>
					본인이 직접 변경한 것이 아니라면 즉시 사무국<strong style="color:#0088B8; font-weight:600;">(010-8441-4484)</strong>으로 연락하여<br>
					계정을 보호하시기 바랍니다.
				</p>
