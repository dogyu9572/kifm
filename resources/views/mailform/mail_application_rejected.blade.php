	...
	<tbody>
		...
		<tr>
			<td style="padding:0 40px 48px;">
				<div style="font-size:24px; color:#222; font-weight:700; line-height:1.4; letter-spacing:-.02em;">위원회 신청 불가 안내</div>
				<p style="font-size:16px; color:#222; line-height:1.5; letter-spacing:-.02em; margin:16px 0 40px;">
					안녕하세요, 대한기능의학회입니다.<br>
					현재 회원님께서는 아래와 같은 사유로 해당 위원회 신청이 제한됨을 안내드립니다.
				</p>
