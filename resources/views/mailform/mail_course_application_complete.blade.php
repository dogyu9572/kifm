		...
		<tr>
			<td style="padding:0 40px 48px;">
				...
				<p style="font-size:16px; color:#222; line-height:1.5; letter-spacing:-.02em; margin:16px 0 40px;">
					안녕하세요, 대한기능의학회입니다.<br>
					회원님께서 신청하신 연수강좌의 접수 및 결제가 완료되었습니다. <br>
				...
				<div style="text-align:center; padding:54px 0 14px;">
					<a href="{{ url('/mypage/online_training') }}" target="_blank" style="font-size:14px; color:#fff; font-weight:600; line-height:1; padding:14px 45px; background:#0088B8; border-radius:8px; text-decoration:none;">나의 신청 내역 확인하기</a>
				</div>
			</td>
		</tr>
		<tr>
