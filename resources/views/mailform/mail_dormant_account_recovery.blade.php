...
<title>휴면 계정 해제 및 비밀번호 재설정을 안내</title>
</head>
<style>
	...
	<tbody>
		...
		<tr>
			<td style="padding:0 40px 48px;">
				<div style="font-size:24px; color:#222; font-weight:700; line-height:1.4; letter-spacing:-.02em;">휴면 계정 해제 및 비밀번호 <br/>재설정을 안내드립니다.</div>
				<p style="font-size:16px; color:#222; line-height:1.5; letter-spacing:-.02em; margin:16px 0 40px;">
					안녕하세요, 대한기능의학회입니다.<br>
					고객님의 소중한 정보를 보호하기 위해 휴면 상태로 전환되었던<br>
					계정을 다시 활성화해 드립니다.  아래 버튼을 눌러 새로운 비밀번호를 설정하시면, 즉시 모든 서비스를 정상적으로<br>
					이용하실 수 있습니다.
				</p>
				<div style="background:#f8f8f8; border-radius:8px; padding:20px; font-size:14px; color:#666; font-weight:400; line-height:1.5;">
					본 비밀번호 초기화 링크는 24시간 동안만 유효합니다.<br>
					만약 본인이 요청한 사항이 아니라면 본 메일을 삭제해 주시기 바랍니다.<br>
					개인정보 보호를 위해 타인에게 이 메일을 공유하지 마세요.
				</div>
				<div style="text-align:center; padding:54px 0 14px;">
					<a href="{{ url('/member/new_password') }}" target="_blank" style="font-size:14px; color:#fff; font-weight:600; line-height:1; padding:14px 45px; background:#0088B8; border-radius:8px; text-decoration:none;">새 비밀번호 설정하기</a>
				</div>
			</td>
		</tr>
		<tr>
