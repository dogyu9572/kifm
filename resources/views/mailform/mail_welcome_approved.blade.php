	...
	<tbody>
		...
		<tr>
			<td style="padding:0 40px 48px;">
				...
				<div style="font-size:16px; color:#222; font-weight:700; line-height:1.5; letter-spacing:-.02em; margin:50px 0 16px; padding-bottom:10px; border-bottom:#222 1px solid;">주요 회원 혜택</div>
				<ul style="list-style:none; padding:0;">
					<li style="font-size:14px; color:#666; font-weight:400; line-height:1.5;">• 학술 자료실:VOD 및 강연록 열람</li>
					<li style="font-size:14px; color:#666; font-weight:400; line-height:1.5;">• 주요 혜택:학회지 및 뉴스레터 정기 발송</li>
					<li style="font-size:14px; color:#666; font-weight:400; line-height:1.5;">• 세미나:정기 학술대회 등록비 할인</li>
				</ul>
				<div style="text-align:center; padding:54px 0 14px;">
					<a href="{{ url('/member/login') }}" target="_blank" style="font-size:14px; color:#fff; font-weight:600; line-height:1; padding:14px 45px; background:#0088B8; border-radius:8px; text-decoration:none;">홈페이지 로그인하기</a>
				</div>
			</td>
		</tr>
		<tr>
