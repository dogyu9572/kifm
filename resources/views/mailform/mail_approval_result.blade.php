	...
	<tbody>
		...
		<tr>
			<td style="padding:0 40px 48px;">
				<div style="font-size:24px; color:#222; font-weight:700; line-height:1.4; letter-spacing:-.02em;">위원회 승인 결과 안내</div>
				<p style="font-size:16px; color:#222; line-height:1.5; letter-spacing:-.02em; margin:16px 0 40px;">
					안녕하세요, 대한기능의학회입니다.<br>
					축하드립니다! 회원님의 위원회 활동 신청이 최종 승인되었습니다.<br>
					앞으로의 활발한 활동을 기대합니다.
				</p>
