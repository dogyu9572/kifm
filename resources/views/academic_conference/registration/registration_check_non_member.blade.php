	...
	<div class="inner">
		...
		<div class="member_inbox">
			<ul class="tabs type_member">
				<li><a href="/academic_conference/registration/check_member">회원 등록</a></li>
				<li class="on"><a href="/academic_conference/registration/check_non_member">비회원 등록</a></li>
			</ul>
			...
			<form action="/academic_conference/registration/result" method="POST" class="inputs gbox">
				...
				<button type="submit" class="btn btn_wkk mt" onclick="location.href='/academic_conference/registration/result'">사전등록 조회</button>
			</form>
