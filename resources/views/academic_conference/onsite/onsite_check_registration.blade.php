	...
	<div class="inner">
		...
		<div class="member_inbox">
			<ul class="tabs type_member">
				<li class="on"><a href="/academic_conference/onsite_check_registration">회원 등록</a></li>
				<li><a href="/academic_conference/onsite_check_non_registration">비회원 등록</a></li>
			</ul>
			...
			<form action="/academic_conference/registration/result" method="POST" class="inputs gbox">
				...
				<button type="submit" class="btn btn_wkk mt" onclick="location.href='/academic_conference/onsite_confirmation_complete'">등록 내역 조회하기</button>
			</form>
			
			<div class="after_txt">
				<p>정보가 기억나지 않으시면 안내 데스크에 문의해 주세요</p>
				<a href="/academic_conference/onsite_info" class="btn_link btn_kwg">현장 등록하러 가기</a>
			</div>
		</div>
