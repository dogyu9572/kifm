...
<section class="onsite_intro_wrap" aria-labelledby="intro-title">
	...
	<div class="intro_contents inner">
		...
		<div class="links">
			...
			<a href="/academic_conference/onsite_check_registration" class="i2"><h3>등록 내역 조회하기</h3><p>이미 사전, 현장 등록(결제)를 <br class="pc_vw" aria-hidden="true">완료 하신 분은 여기서 등록 내역을 확인하세요.</p><i class="btn">조회하기</i></a>
		</div>
