	...
	<div class="inner">
		...
		<div class="member_inbox">
			<form action="" method="POST" class="inputs gbox">
				...
				<button type="submit" class="btn btn_wkk" onclick="/academic_conference/onsite_member_registration">로그인</button>
				<a href="/academic_conference/onsite_non_member_registration" class="btn btn_kwk">비회원으로 신청하기</a>
			</form>
