...
@section('sName', $sName)
@section('content')
<main class="sub_area onsite_wrap">
	...
	<div class="inner">
        ...
        <div class="inbox">
			<form action="/payment/process" method="post">
                <fieldset>
                    ...
                    <ul class="inputs">
                        <li>
                            ...
                            <input type="text" id="user_name" name="user_name" class="text" placeholder="이름을 입력해주세요" required title="이름 입력 필수" readonly value="홍길동">
                        </li>
                        <li>
                        ...
                        <li>
							...
							<input type="text" id="major_subject" name="major_subject" class="text" placeholder="전공과목을 입력해주세요" required title="전공과목 입력 필수">
                        </li>
                        <li>
                            <label for="affiliated_hospital">소속병의원명<span class="required">*</span></label>
							<input type="text" id="affiliated_hospital" name="affiliated_hospital" class="text" placeholder="소속병의원명을 입력해주세요" required title="소속병의원명 입력 필수">
                        </li>
                        <li>
                            <label for="address">주소<span class="required">*</span></label>
							<div class="inbtn">
								<input type="text" id="address" name="address" class="text" placeholder="우편번호를 입력해주세요" required title="우편번호 입력 필수">
								<button type="button" class="btn btn_wkk">주소 확인</button>
							</div>
							<input type="text" id="address" name="address" class="text" placeholder="주소를 입력해주세요" required title="주소 입력 필수">
                ...
                <fieldset>
                    <legend class="form_tit">회비 납부</legend>
					<ul class="radios float">
						<li>
							<div class="radio">
								<input type="radio" name="payment_select" id="payment_select11">
								<label for="payment_select11"><i aria-hidden="true"></i><span>미선택 <strong>120,000원</strong></span></label>
							</div>
						</li>
						<li>
							<div class="radio">
								<input type="radio" name="payment_select" id="payment_select12">
                ...
                <fieldset>
					...
					<ul class="radios float">
						<li>
							<div class="radio">
								<input type="radio" name="payment_select" id="payment_select21" disabled>
								<label for="payment_select21"><i aria-hidden="true"></i><span>사전등록비 (준회원) <strong>120,000원</strong></span></label>
							</div>
						</li>
						<li>
							<div class="radio">
								<input type="radio" name="payment_select" id="payment_select22">
								<label for="payment_select22"><i aria-hidden="true"></i><span>사전등록비 (정회원) <strong>120,000원</strong></span></label>
							</div>
						</li>
						<li>
							<div class="radio">
								<input type="radio" name="payment_select" id="payment_select23">
								<label for="payment_select23"><i aria-hidden="true"></i><span>사전등록비 (전공의, 공보의) <strong>60,000원</strong></span></label>
							</div>
						</li>
					</ul>
                </fieldset>
                ...
                <article class="abso_application">
                    ...
                    <button type="submit" class="btn_submit btn_wbb" onclick="location.href='/academic_conference/onsite_welcome_approved'"><span class="sound_only">240,000원 </span>결제하기</button>
                </article>
            </form>
        </div>
	</div>
