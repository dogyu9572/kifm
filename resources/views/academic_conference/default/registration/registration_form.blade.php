                ...
                <fieldset>
                    ...
                    <ul class="inputs">
                        ...
                        <li>
							...
							<input type="text" id="address_detail" name="address_detail" class="text" value="{{ $member?->address_detail ?: $member?->workplace_address_detail }}" placeholder="상세주소를 입력해주세요" required title="상세주소 입력 필수" readonly>
                        </li>
                    </ul>
                </fieldset>
