					...
					<fieldset>
						...
						<ul class="inputs float">
							<li>
								...
								<input type="text" id="user_name" name="user_name" class="text" value="홍길동" readonly>
							</li>
							<li>
								<label for="user_name_eng" class="tit">이름(영문)</label>
								<input type="text" id="user_name_eng" name="user_name_eng" class="text" value="홍길동" readonly>
							</li>
							<li>
								<label for="user_phone" class="tit">전화번호</label>
								<input type="tel" id="user_phone" name="user_phone" class="text" value="010-1234-5678" readonly>
							</li>
							<li>
								<label for="user_tel" class="tit">휴대폰번호</label>
								<input type="tel" id="user_tel" name="user_tel" class="text" value="010-1234-5678" readonly>
							</li>
							<li>
								<label for="user_email" class="tit">이메일</label>
								<input type="email" id="user_email" name="user_email" class="text" value="home@homepagekorea.com" readonly>
							</li>
						</ul>
					</fieldset>
						...
						<ul class="inputs float">
							<li>
								...
								<div class="select_abstract">
									<div class="select_check"><input type="checkbox" id="abstract-committee01" name="abstract-committee" checked><label for="abstract-committee01"><span>기조강연</span></label></div>
							...
							<li>
								...
								<div class="select_abstract">
									<div class="select_check"><input type="checkbox" id="speak-committee01" name="speak-committee" checked><label for="speak-committee01"><span>분야명 1</span></label></div>
