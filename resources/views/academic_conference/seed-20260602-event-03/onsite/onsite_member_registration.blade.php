        ...
        <div class="inbox">
			<form action="/payment/process" method="post">
                ...
                <article class="abso_application">
                    ...
                    <button type="submit" class="btn_submit btn_wbb" onclick="location.href='{{ $conferenceBaseUrl }}/onsite_welcome_approved'"><span class="sound_only">240,000원 </span>결제하기</button>
                </article>
            </form>
        </div>
	</div>
